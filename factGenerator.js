...
async function generateFactImage(imagePath) {
    let fact =randomFact();
    let image = await getRandomImage(fact.animal);
    await editImage(image, imagePath, fact.fact);
...
module.exports = { generateFactImage, deleteImage }